...
<LinearGradient
      // Background Linear Gradient
      colors={['#bb083e' , '#fe6292','white']}  style={{display:'flex',justifyContent:'space-around',width:'100%',flex:'1',borderColor:'#ececec',borderTopEndRadius:moderateScale(65),paddingTop:verticalScale(35),paddingHorizontal:scale(25),marginTop:verticalScale(15)}}>
<Text style={{color:'white',fontSize:RFPercentage(4),fontWeight:700   , fontFamily: 'CuteFont',}}>SignUp</Text>
...
paddingHorizontal:width*0.02,borderRadius:moderateScale(25),height:verticalScale(50), fontFamily: 'CuteFont'}} placeholder="Enter your email" />
...
<Text style={{display:'flex',alignItems:'center',justifyContent:'space-around',color:'#f1f1f1',fontSize:RFPercentage(2.3),fontWeight:400,marginTop:verticalScale(25),marginLeft:scale(5),    fontFamily: 'CuteFont'}} >you have already account?<Text style={{fontWeight:600,color:"#b5009a",marginTop:width*0.1,    fontFamily: 'CuteFont'}}>Sign in</Text> </Text>




<TouchableOpacity style={{backgroundColor:'red',marginTop:verticalScale(10),justifyContent:'center',alignItems:'center',borderRadius:moderateScale(25),width:scale(150),paddingVertical:verticalScale(10)}}>
<Text style={{color:'white',fontSize:RFPercentage(2.15),fontWeight:500, fontFamily: 'CuteFont'}}>Create new account</Text>
</TouchableOpacity>
